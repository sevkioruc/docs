...
define your entities, relations between them and access control decisions with using this schema. Here’s a simple breakdown of our schema.
...
control example for better understanding. To see completed model you can jump directly to [Github Example](#github-example). 
...
You can find more example usages from example use cases in [Guides Section].
