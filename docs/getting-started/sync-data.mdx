...
After database configuration is done and Permify API is running as a REST API on your server. Relational tuples need to migrated or created in writedb. Additionally relational tuples can also be created, updated or deleted in runtime, since relations and authorization data's are live instances.
